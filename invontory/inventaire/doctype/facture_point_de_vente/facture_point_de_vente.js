...
erpnext.accounts.taxes.setup_tax_validations("facture point de vente");
erpnext.accounts.payment_triggers.setup("facture point de vente");
erpnext.accounts.pos.setup("facture point de vente");
...
/* erpnext.accounts.SalesInvoiceController = class SalesInvoiceController extends (
	...
	// Récupérer la ligne de l'élément ajouté
	let row = frappe.get_doc(cdt, cdn);

	// Vérifier si `frm` est défini pour éviter les erreurs
	if (this.frm) {
